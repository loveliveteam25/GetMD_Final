...
private void initComponents() {
        ...
        setTitle("GetMD Experience --- Doctor");
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        DoctorLoginDialog.this.dc.whichButtonOnLogin = 1;
        DoctorLoginDialog.this.dc.setLoginInfo(id,
    ...
    private void signupButtonActionPerformed(java.awt.event.ActionEvent evt) {
       // DoctorLoginDialog.this.dc.whichButtonOnLogin = 2;
       // dispose();
    }

    private void exitButtonActionPerformed(java.awt.event.ActionEvent evt) {
        DoctorLoginDialog.this.dc.whichButtonOnLogin = 0;
        dispose();
    }
    /**
     *
    ...
    public DoctorLoginDialog(Frame parent, DoctorClient dc, int id, String password) {
