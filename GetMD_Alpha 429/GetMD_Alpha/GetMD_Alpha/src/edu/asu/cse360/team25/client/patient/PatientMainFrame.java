...
public class PatientMainFrame extends javax.swing.JFrame {
    ...
    protected int selectedDoctorID;
    ...
    private void initComponents() {
        ...
        ta_docResu.setColumns(20);
        ta_docResu.setRows(5);
        ta_docResu.setEnabled(false);
        jScrollPane5.setViewportView(ta_docResu);
        ...
        lb_docName.setText("Doctor Name: ");
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        //updatePatientInfo();// TODO add your handling code here:
        try {
            updatePatientInfo();
    ...
    private javax.swing.JLabel lb_docName;
    ...
    private javax.swing.JTextArea ta_docResu;
